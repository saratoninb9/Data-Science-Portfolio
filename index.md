---
layout: default
title: Data Science Projects - by Sara Oliveira
---
...
**Techniques:** image segmentation (Segment Anything Model), CNN feature extraction (ResNet50), Grad-CAM, self-supervised learning (XGBoost), sales forecasting
